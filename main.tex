...
\nomenclature[A]{\textbf{HCI}}{Human Computer Interaction}
\nomenclature[A]{\textbf{AIS}}{Area of Information Systems}
\nomenclature[A]{\textbf{UT}}{University of Texas}
\nomenclature[A]{\textbf{VHB}}{Verband der Hochschullehrer für Betriebswirtschaft}
\nomenclature[A]{\textbf{CCH}}{Consumer Choice}
\nomenclature[A]{\textbf{EDU}}{Education}
\nomenclature[A]{\textbf{FIN}}{Finance}
\nomenclature[A]{\textbf{HEA}}{Health}
\nomenclature[A]{\textbf{PSB}}{Pro-social Behavior}
\nomenclature[A]{\textbf{SUS}}{Sustainability}
\nomenclature[A]{\textbf{TRA}}{Transportation}
\nomenclature[A]{\textbf{SCP}}{Security and Privacy}
\nomenclature[A]{\textbf{GOV}}{Government}
\nomenclature[A]{\textbf{MISC}}{Miscellaneous}
\nomenclature[A]{\textbf{Lab}}{Laboratory}
